        ...
        <div class="iq-sidebar">
            <div class="iq-sidebar-logo d-flex justify-content-between">
                <a href="index.html" class="header-logo">
                    <img src="images/logo-7040.png" class="img-fluid rounded-normal" alt="">
                ...
                <nav class="iq-sidebar-menu">
                    <ul id="iq-sidebar-toggle" class="iq-menu">
                        <li class="active active-menu">
                            <a href="?"><i class="las la-house-damage"></i><span>Dashboard</span></a>
                        ...
                        <li>
                            <a href="?page=produk" class="iq-waves-effect">
                                <i class="las la-book"></i><span>Produk</span>
                            </a>
                        </li>
                        <li>
                            <a href="logout.php">
                    ...
                    <div class="iq-card bg-primary rounded">
                        <div class="iq-card-body">
                            <div class="sidebarbottom-content">
                                <div class="image"><img src="images/side-nav.png" alt=""></div>
                    ...
                    <ul class="navbar-list">
                        <li class="line-height">
                            <a href="#" class="search-toggle iq-waves-effect d-flex align-items-center">
                                <img src="images/user.png" class="img-fluid rounded-circle" alt="user">
                            </a>
