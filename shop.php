...
<head>
    <title>Kara Handycrafts - Accecories</title>
    <meta charset="utf-8">
                ...
                <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasNavbar2"
                    ...
                    <div class="offcanvas-body align-items-center">
                        <ul class="navbar-nav ms-5 flex-grow-1 pe-3">
                            ...
                            <li class="nav-item ms-3 ">
                                <a class="nav-link text-dark" href="galeri.php">Gallery</a>
                            </li>
                        </ul>
    ...
    <section id="featured-product" class="py-lg-6 bg-light position-relative">
        <div class="container-lg">
            <div class="display-header text-center position-relative">
                ...
                <h2 class="display-2 mt-0">Produk Kami</h2>
            </div>
            <div class="swiper product-swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="product-item">
                            <div class="image-holder text-center p-3 mb-4 border rounded-4">
                                <img src="images/Product-1 (2).jpeg" alt="toy" class="img-fluid">
                            </div>
                            <div class="product-info ps-2">
                                <h3 class="m-0">
                                    <a href="single-product.html" class="text-secondary">Gelang Kristal Pita Pink</a>
                                </h3>
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <div class="image-holder text-center p-3 mb-4 border rounded-4">
                                <img src="images/Product-1 (3).jpeg" class="img-fluid">
                            </div>
                            <div class="product-info ps-2">
                                <h3 class="m-0">
                                    <a href="single-product.html" class="text-secondary">Gelang Kristal Pita Pink</a>
                                </h3>
                                <div class="product-price text-primary">Rp20.000</div>
                                <a href="cart.html"
                                    class="btn btn-outline-gray text-capitalize rounded-pill mt-4 btn-sm"
                                    data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                                    aria-controls="offcanvasCart">Order Now
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <div class="image-holder text-center p-3 mb-4 border rounded-4">
                                <img src="images/Product-1 (4).jpeg" alt="toy" class="img-fluid">
                            </div>
                            <div class="product-info ps-2">
                                <h3 class="m-0">
                                    <a href="single-product.html" class="text-secondary">Gantungan Black n White</a>
                                </h3>
                                <div class="product-price text-primary">Rp20.000</div>
                                <a href="cart.html"
                                    class="btn btn-outline-gray text-capitalize rounded-pill mt-4 btn-sm"
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <div class="image-holder text-center p-3 mb-4 border rounded-4">
                                <img src="images/Product-1 (5).jpeg" alt="toy" class="img-fluid">
                            </div>
                            <div class="product-info ps-2">
                                <h3 class="m-0">
                                    <a href="single-product.html" class="text-secondary">Uffy Unicorn</a>
                                </h3>
                                <div class="product-price text-primary">$20.000</div>
                                <a href="cart.html"
                                    class="btn btn-outline-gray text-capitalize rounded-pill mt-4 btn-sm"
                                    data-bs-toggle="offcanvas" data-bs-target="#offcanvasCart"
                                    aria-controls="offcanvasCart">Order Now
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            ...
                            <div class="product-info ps-2">
                                <h3 class="m-0">
                                    <a href="single-product.html" class="text-secondary">Uffy b sb b</a>
                                </h3>
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <div class="image-holder text-center p-3 mb-4 border rounded-4">
                                <img src="images/product-1(7).jpg" alt="toy" class="img-fluid">
                            </div>
                            <div class="product-info ps-2">
                                <h3 class="m-0">
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6 mb-3">
                    <div class="d-flex flex-wrap align-items-center">
                        <img src="images/logo.png" alt="brand name" class="pe-5">
